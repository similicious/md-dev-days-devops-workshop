...
resource keyVaultSettings 'Microsoft.KeyVault/vaults@2021-10-01' existing = {
  ...
  resource storageConnectionString 'secrets' = {
    ...
    properties: {
      value: 'DefaultEndpointsProtocol=https;AccountName=${storageAccountName};AccountKey=${listKeys(resourceId(resourceGroup().name, 'Microsoft.Storage/storageAccounts', storageAccountName), '2021-09-01').keys[0].value};EndpointSuffix=core.windows.net'
    }
  }
}
